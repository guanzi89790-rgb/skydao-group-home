...
export const featureSections = [
  ...
  },
  {
    ...
    button: '了解 AIES',
    image: '/pages/wallet/assets/aies/aies-summit-collage-2026.png',
    align: 'left',
  },
]

const aboutSlides = [
  '/pages/wallet/assets/about/about-hongkong-skyline-01.png',
  '/pages/wallet/assets/about/about-hongkong-skyline-02.png',
]
...
const physicalAIProducts = [
  {
    image: '/pages/wallet/assets/products/ness-ai-companion.jpg',
    kicker: 'NESS.AI · DISPLAY 01',
    name: 'Ness.AI',
    label: '深度情感陪伴与互动 Choupette',
  },
  {
    image: '/pages/wallet/assets/products/humanoid-robot-lab.jpg',
    kicker: 'NESS.AI · DISPLAY 02',
    name: 'Ness.AI',
    label: '深度情感陪伴与互动 Choupette',
  },
  {
    image: '/pages/wallet/assets/products/designer-cat-ip.jpg',
    kicker: 'KARL LAGERFELD · DISPLAY 01',
    name: 'Karl Lagerfeld',
    label: '（老佛爷）标志性爱猫 Choupette 正版版权',
  },
  {
    image: '/pages/wallet/assets/products/ai-cat-companion.jpg',
...
const heroImages = [
  '/pages/wallet/assets/hero/central-gate-energy-base.jpg',
  '/pages/wallet/assets/hero/central-gate-valley.jpg',
  '/pages/wallet/assets/hero/central-gate-datacenter.jpg',
]
  ...
  return (
    <div className="hero-media" aria-hidden="true">
      ...
      <div className={`hero-media-layer hero-video-layer ${activeMedia === 'video' ? 'is-active' : ''}`}>
        ...
        >
          <source src="/pages/wallet/assets/hero/central-gate-aerial.mp4" type="video/mp4" />
        </video>
      </div>
    </div>
  )
    ...
    <section className="hero fullpage-panel" id="central-gate" data-panel-label="Central Gate">
      ...
      <div className="hero-content">
        ...
        <div className="hero-actions hero-intro-item">
          <a className="sai-pill is-dark" href="#/central-gate">了解中央之门</a>
          <a className="sai-pill" href="#about">集团价值链</a>
        </div>
      </div>
    </section>
  )
    ...
    <main className="central-page">
      <section className="hero central-detail-hero central-starship-hero fullpage-panel" id="cg-definition" data-panel-label="Definition">
        <div className="central-detail-bg" aria-hidden="true">
          <img src="/pages/wallet/assets/central-gate/cg-energy-campus-20260626.png" alt="" />
        </div>
      ...
      <CentralGateSection
        ...
        title="能源 × 算力一体化系统"
        background="/pages/wallet/assets/central-gate/cg-dc-power-corridor-20260626.png"
        tone="left"
      >
      ...
      <CentralGateSection
        ...
        title="工业级AI计算网络"
        background="/pages/wallet/assets/central-gate/cg-gpu-hall-20260626.png"
        tone="counter"
      >
      ...
      <CentralGateSection
        ...
        title="AI进入智能体时代"
        background="/pages/wallet/assets/central-gate/cg-highland-grid-20260626.png"
        tone="horizon"
      >
      ...
      <CentralGateSection
        ...
        title="模块化AI基础设施网络"
        background="/pages/wallet/assets/central-gate/cg-modular-buildout-20260626.png"
        tone="left"
      >
      ...
      <div className="official-footer-shell">
        <div className="official-footer-top">
          ...
          <div className="official-footer-brand">
            <img src="/pages/wallet/assets/brand/skydao-logo-light.svg" alt="SkyDAO" />
