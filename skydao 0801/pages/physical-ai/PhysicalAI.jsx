  ...
  return (
    <main ref={pageRef} className="sai-page about-text-motion">
      ...
      <footer className="sai-footer">
        ...
        <div className="sai-frame sai-footer-bottom">
          <span>{locale === 'zh' ? '© 2026 硅基智造 版权所有' : '© 2026 Physical AI. All rights reserved.'}</span>
          <span>{locale === 'zh' ? '粤 ICP 备 2025001234 号' : 'ICP Filing No. 2025001234'}</span>
        </div>
      </footer>
