  ...
  return <div className="skydao" ref={root}>
    <header className="site-header">
      ...
      <nav className="header-nav" aria-label="Primary navigation">
        {[
          ['Central Gate', '中央之门', '#/central-gate'], ['Physical AI', '链基智造', '#/physical-ai'],
    ...
    <main>
      ...
      <section className="finale chapter" id="chapter-08">
        ...
        <footer><span>© 2026 SkyDAO Group</span><span>{t.global}</span><button onClick={() => goTo('#opening')}>{t.top}</button></footer>
      </section>
    </main>
  </div>
}
