...
function PhysicalAIApp() {
  ...
  return <div ref={shellRef} className="site-shell site-shell-physical-ai"><SiteNavigation currentPage="physical-ai" darkSectionId="sai-progress" locale={locale} onLocaleChange={setLocale} onNavigate={navigate} theme="light" /><PhysicalAI locale={locale} /></div>
}
