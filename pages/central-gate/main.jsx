...
function CentralGateApp() {
  ...
  return <div ref={shellRef} className="site-shell site-shell-central-gate"><Navigation locale={locale} onLocaleChange={setLocale} onNavigate={navigate} /><CentralGate locale={locale} /></div>
}
