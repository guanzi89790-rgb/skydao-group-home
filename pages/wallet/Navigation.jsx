    ...
    <>
      <header className="page-navigation">
        <button className="page-navigation__brand" type="button" onClick={() => navigate('#/')} aria-label="SkyDAO Group home">
          <img className="page-navigation__logo page-navigation__logo--dark" src="/pages/wallet/assets/brand/skydao-logo-dark.svg" alt="SkyDAO Group" />
          <img className="page-navigation__logo page-navigation__logo--light" src="/pages/wallet/assets/brand/skydao-logo-light.svg" alt="" aria-hidden="true" />
        </button>
