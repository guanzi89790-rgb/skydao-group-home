...
export const featureSections = [
  ...
  },
  {
    ...
    button: '了解 AIES',
    image: '/pages/home/assets/aies/aies-summit-collage-2026.png',
    align: 'left',
  },
]

const aboutSlides = [
  '/pages/home/assets/about/about-hongkong-skyline-01.png',
  '/pages/home/assets/about/about-hongkong-skyline-02.png',
]
...
const physicalAIProducts = [
  {
    image: '/pages/home/assets/products/ness-ai-companion.jpg',
    kicker: 'Ness.AI · DISPLAY 01',
    name: 'Ness.AI',
    label: '深度情感陪伴与互动 Choupette',
  },
  {
    image: '/pages/home/assets/products/humanoid-robot-lab.jpg',
    kicker: 'Ness.AI · DISPLAY 02',
    name: 'Ness.AI',
    label: '深度情感陪伴与互动 Choupette',
  },
  {
    image: '/pages/home/assets/products/designer-cat-ip.jpg',
    kicker: 'KARL LAGERFELD · DISPLAY 01',
    name: 'Karl Lagerfeld',
    label: '（老佛爷）标志性爱猫 Choupette 正版版权',
  },
  {
    image: '/pages/home/assets/products/ai-cat-companion.jpg',
...
const walletCards = [
  {
    ...
    image: '/pages/home/assets/wallet/wallet-digital-asset.png',
  },
  {
    badge: 'Card',
    icon: '▭',
    ...
    cta: 'Pay',
    image: '/pages/home/assets/wallet/wallet-global-card.png',
  },
  {
    badge: 'Yield',
    icon: '▥',
    ...
    image: '/pages/home/assets/wallet/wallet-rwa-yield.png',
  },
]
    ...
    <main className="central-page">
      <section className="hero central-detail-hero central-starship-hero fullpage-panel" id="cg-definition" data-panel-label="Definition">
        <div className="central-detail-bg" aria-hidden="true">
          <img src="/pages/home/assets/central-gate/cg-energy-campus-20260626.png" alt="" />
        </div>
      ...
      <CentralGateSection
        ...
        title="能源 × 算力一体化系统"
        background="/pages/home/assets/central-gate/cg-dc-power-corridor-20260626.png"
        tone="left"
      >
      ...
      <CentralGateSection
        ...
        title="工业级AI计算网络"
        background="/pages/home/assets/central-gate/cg-gpu-hall-20260626.png"
        tone="counter"
      >
      ...
      <CentralGateSection
        ...
        title="AI进入智能体时代"
        background="/pages/home/assets/central-gate/cg-highland-grid-20260626.png"
        tone="horizon"
      >
      ...
      <CentralGateSection
        ...
        title="模块化AI基础设施网络"
        background="/pages/home/assets/central-gate/cg-modular-buildout-20260626.png"
        tone="left"
      >
      ...
      <div className="official-footer-shell">
        <div className="official-footer-top">
          ...
          <div className="official-footer-brand">
            <img src="/pages/home/assets/brand/skydao-logo-light.svg" alt="SkyDAO" />
            <p>{locale === 'zh' ? '打通数位与现实，重塑未来金融边界' : 'Connecting digital and real-world value to reshape the future of finance.'}</p>
          </div>
          <nav className="official-footer-nav" aria-label={locale === 'zh' ? '页脚导航' : 'Footer navigation'}>
